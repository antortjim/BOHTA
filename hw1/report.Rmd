...
normal.quantiles <- qnorm ((1:18489-0.5)/18489,mean=0, sd=exon.sd)
...
ggplot(data = new_set, mapping = aes(x = normal.quantiles, y=exon.length)) + 
...
plot(df$mrna_length, df$intron_length, pch = 19, ylab="Intron Lengths", xlab = "Exon Lengths")
abline(model_1, col = "blue")

model_2 <- lm(df$exon_count ~ df$mrna_length)
plot(df$mrna_length, df$exon_count, pch = 19, ylab="Exon Count", xlab = "Exon Lengths")
