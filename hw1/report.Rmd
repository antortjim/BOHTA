...
Our null hypothesis is that there is no difference in the U-statistic of the exons and introns lengths. In contrast, our alternative hypothesis is that there is difference in the U-statistic of the exons and introns lengths, meaning that the length distributions are significantly different.
