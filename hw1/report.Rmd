...
As our p-value is lower than 0.05 (< 2.2e-16), we can reject the null hypothesis and accept the alternative hypothesis, that is, there is a significant difference in the U-statistic between the length of the exons and introns. This means that the introns are significantly longer than the exons.
