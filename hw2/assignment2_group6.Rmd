...
![_Screenshot of the start of AK002007. The first 7 letters are discarded by the aligner, while the following 4 are aligned to the end of the intron._](AK002007_1.png)

![_Screenshoot of the upstream exon. As we can see, the last letters of the exon match the letters aligned to the intron._](AK002007_2.png)
...
R
```{r fig.height = 3, warning = F, messages = F, include = T}
...
![_Barplot of the coverage across the genome for ERa, Erb and the intervals resulting for a total merge of both._](merged_barplot.png)
